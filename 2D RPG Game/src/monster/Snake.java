...
public class Snake extends Monster {
	...
	public Snake(GamePanel gp) {
		super(gp);
		idle = new SpriteSheet("/monster_snake/Idle.png", 896, 128, 7, 12, 34, 94, 94).animation;
		move = new SpriteSheet("/monster_snake/Walk.png", 1664, 128, 13, 3, 28, 100, 100).animation;
		attackImage = new SpriteSheet("/monster_snake/Attack_3.png", 1280, 128, 10, 0, 26, 126, 102).animation;
		flip = false;
